...
export const ALL_LESSONS: Lesson[] = [...SQL_ALL, ...EXCEL_LESSONS, ...AB_LESSONS, ...ORAL_LESSONS];
export const ALL_CASES: BizCase[] = [...CASES, ...CASES_INTERVIEW].map(withDrill);
export const LEARN_PATH: Lesson[] = [...SQL_BASIC, ...EXCEL_LESSONS, ...SQL_INTERVIEW, ...AB_LESSONS, ...ORAL_LESSONS];
